...
<div class="row">
	<div class="col-md-12">
<div class="card">
  <div class="card-header text-white bg-primary">Reporte de citas</div>
  <div class="card-body">
<br>
  ...
  <?php endforeach; ?>
    ...
    <div class="col-lg-3">
		<div class="input-group">
		  ...
		  <input type="date" name="start_at" value="<?php if(isset($_GET["start_at"]) && $_GET["start_at"]!=""){ echo $_GET["start_at"]; } ?>" class="form-control" placeholder="Fecha inicio">
		</div>
    </div>
    <div class="col-lg-3">
		<div class="input-group">
		  <span class="input-group-text">FIN</span>
		  <input type="date" name="finish_at" value="<?php if(isset($_GET["finish_at"]) && $_GET["finish_at"]!=""){ echo $_GET["finish_at"]; } ?>" class="form-control" placeholder="Fecha fin">
		</div>
    </div>
...
<option value="">-- PAGO --</option>
  ...
  <?php endforeach; ?>
    ...
    <div class="col-lg-6">
    <button class="btn btn-primary d-block w-100">Procesar</button>
    </div>
